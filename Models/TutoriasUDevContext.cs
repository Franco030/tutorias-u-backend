...
public partial class TutoriasUDevContext : DbContext
{
    public TutoriasUDevContext()
    {
    }

    public TutoriasUDevContext(DbContextOptions<TutoriasUDevContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=tcp:srv-tutorias-edwin.database.windows.net,1433;Initial Catalog=TutoriasU-dev;Persist Security Info=False;User ID=dev_team;Password=@1qwerty1@;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
